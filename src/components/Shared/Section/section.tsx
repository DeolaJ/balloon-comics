...
export const Section: FC<PropsWithChildren<SectionProps>> = ({ children, className, style }) => (
  <motion.section
    variants={fadeInUp}
    style={style}
    className={twMerge(`px-6 sm:px-10 md:px-14 py-12 ${className}`)}>
    {children}
  </motion.section>
);
...
export const SectionTitle: FC<PropsWithChildren<SectionProps>> = ({
  children,
  style,
  className,
}) => (
...
export const SectionTitleSub: FC<PropsWithChildren<SectionProps>> = ({
  children,
  style,
  className,
}) => (
